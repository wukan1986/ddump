...
def _code_block_1():
    ...
    SSE50 = cs_scale(ts_cum_prod_by(cs_fill_except_all_null(sz50), ROCR), 100)
    CSI300 = cs_scale(ts_cum_prod_by(cs_fill_except_all_null(hs300), ROCR), 100)
    CSI500 = cs_scale(ts_cum_prod_by(cs_fill_except_all_null(zz500), ROCR), 100)
    CSI1000 = cs_scale(ts_cum_prod_by(cs_fill_except_all_null(zz1000), ROCR), 100)
